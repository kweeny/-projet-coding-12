          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="#blog" class="nav-link js-scroll-trigger">Event</a></li>
                         <li><a href="#work" class="nav-link js-scroll-trigger">Our Work</a></li>
                         <li><a class="nav-link js-scroll-trigger" href="/admin">Admin</a></li>
                         <li><a href="#contact" class="nav-link js-scroll-trigger">Contacts</a></li>
                    </ul>
